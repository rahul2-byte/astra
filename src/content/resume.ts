...
export const resumeSummary =
  "Machine Learning Engineer with 4+ years of production experience extending and shipping fuel analytics algorithms, building ML-backed detection systems, and developing multi-agent LLM applications. Skilled in Python, scikit-learn, LightGBM, LangGraph, and RAG pipelines. Delivered production features including sub-threshold fuel event detection, data-loss alerting, and a multi-stage movie recommendation engine on AWS Lambda.";
...
export const resumeProjects = [
  {
    ...
    bullets: [
      "Designed a multi-agent financial intelligence platform using LangGraph and FastAPI, routing tasks across specialized research, validation, synthesis, and reporting agents.",
      "Built a freshness-aware RAG pipeline using pgvector and sentence-transformers to retrieve financial news, filings, and market context for grounded AI responses.",
      ...
      "Used Opik traces to inspect retrieved context, agent outputs, latency, and unsupported-claim patterns across multi-agent financial analysis runs.",
    ],
  },
  {
